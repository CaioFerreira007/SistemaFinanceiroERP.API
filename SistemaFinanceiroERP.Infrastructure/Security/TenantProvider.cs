...
namespace SistemaFinanceiroERP.Infrastructure.Data
{
    public class AppDbContext : DbContext
    {
        ...
        // ✅ Importante: valor por request (não vira constante no modelo)
        ...
        // Construtor usado por migrations/design-time (sem HttpContext)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Regras:
            // - Se CurrentEmpresaId == 0 => NÃO filtra (para login/register/design-time)
            // - Se CurrentEmpresaId != 0 => filtra por EmpresaId e Ativo
            // ================================
        ...
        // ================================
        // Evita exceção em login/register
        // ================================
